<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Pengarang.aspx.vb" Inherits="DataPerpustakaan.Pengarang" %>
...
<body>
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td class="auto-style4" colspan="2"><h2>DATA PENGARANG</h2></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style14">Tanggal Lahir</td>
        ...
        <tr>
            <td class="auto-style23">&nbsp;</td>
            <td class="auto-style11">Kebangsaan</td>
            <td class="auto-style7">
